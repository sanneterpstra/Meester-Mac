              ...
              <tr>
                <td class="sm-px-6" style="border-radius: 4px; background-color: #fff; padding: 48px; font-size: 16px; color: #334155; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)">
                  <h1 class="sm-leading-8" style="margin: 0; font-size: 24px; font-weight: 600; color: #000">
                    Beste {{ $steps['contact-info']['fields']['first_name'] }},
                  </h1>
                  <div role="separator" style="line-height: 10px; `mso-line-height-alt: ${msoHeight}` }}">&zwj;</div>
                  <p>Bedankt voor je aanvraag bij Meester Mac voor hulp aan huis. Je aanvraag is succesvol ontvangen. Binnen een werkdag ontvang je een bevestiging van de afspraak of een voorstel voor een andere datum/tijdstip.</p>
                  ...
                  <table style="width: 100%; table-layout: auto" cellpadding="0" cellspacing="0" role="none">
                    <tr>
                      <td style="width: 33.333333%; padding-top: 16px; padding-bottom: 16px; vertical-align: top">
                        <p style="margin: 0; color: #111827">Probleem:</p>
                      </td>
                      <td style="width: 66.666667%; padding-top: 16px; padding-bottom: 16px; vertical-align: top">{!! nl2br($steps['problem-description-step']['fields']['problem']) !!}</td>
                    </tr>
                    <tr>
                      <td colspan="2">
                        <div role="separator" style="background-color: #e2e8f0; height: 1px; line-height: 1px; `background-color: $color;">&zwj;</div>
                    ...
                    <tr>
                      <td style="width: 33.333333%; padding-top: 16px; padding-bottom: 16px; vertical-align: top;">
                        <p style="margin: 0; color: #111827;">Adres:</p>
                      </td>
                      <td style="width: 66.666667%; padding-top: 16px; padding-bottom: 16px; vertical-align: top;">{{ $steps['contact-info']['fields']['address'] }} {{ $steps['contact-info']['fields']['housenumber'] }}<br>
                        {{ $steps['contact-info']['fields']['postalcode'] }} {{ $steps['contact-info']['fields']['city'] }}
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
                    ...
                    <tr>
                      ...
                      <td style="width: 66.666667%; padding-top: 16px; padding-bottom: 16px; vertical-align: top;">{{ $steps['date-time-step']['fields']['date'] }} om {{ $steps['date-time-step']['fields']['time'] }} </td>
                    </tr>
                  </table>
                  <div role="separator" style="background-color: #e2e8f0; height: 1px; line-height: 1px; `background-color: $color;">&zwj;</div>
                  <div role="separator" style="line-height: 40px; `mso-line-height-alt: ${msoHeight}` }}">&zwj;</div>
                  <p style="margin: 0;">Let op: De afspraak staat nog niet vast. Zodra deze is bevestigd, krijg je hiervan bericht met een overzicht van de geschatte voorrijkosten.
                    <br>
                    <br>
