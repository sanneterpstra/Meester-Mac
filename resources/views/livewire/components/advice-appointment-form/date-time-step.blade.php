<div class="overflow-hidden">
    @include('livewire.components.advice-appointment-form.navigation')
    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
        <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div class="col-span-full">
                <label class="block text-base font-medium leading-6 text-gray-900" for="date"> Waarover wil je
                    advies? </label>
                <x-input.textarea id="message" name="message" rows="8" wire:model.debounce.500ms="fields.message"
                    placeholder="Probeer kort te omschrijven waar je advies over nodig hebt." :error="$errors->has('fields.message')" />
            ...
            <div class="col-span-full" wire:init="loadUnavailabledates">
                @if ($datesAvailable)
                    <label class="block text-base font-medium leading-6 text-gray-900" for="date"> Welke dag komt
                        het
                        beste uit? </label>
            ...
            <div class="col-span-full">
                ...
                <fieldset class="@if ($errors->has('fields.time')) {{ 'border-red-500' }} @endif mt-1 border">
                    <div class="relative -space-y-px bg-white">
                        <label
                            class="relative flex cursor-pointer flex-col border-b p-4 focus:outline-none md:grid md:grid-cols-3 md:pl-4 md:pr-6">
                        ...
                        <label
                            class="relative flex cursor-pointer flex-col p-4 focus:outline-none md:grid md:grid-cols-3 md:pl-4 md:pr-6">
                            <span class="flex items-center">
                                <input class="peer h-4 w-4 border-gray-300 text-blue-800 focus:ring-blue-800"
